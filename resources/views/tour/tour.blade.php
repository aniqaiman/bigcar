...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal modal-info fade" id="add-tour" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
                  ...
                  <form action="#" method="POST" id="frm-tour-create" enctype ="multipart/form-data">
                  {!! csrf_field() !!}
                    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs ">
            ...
            <li class="pull-right"> 
            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#add-tour">Add Tour</button></li>
          </ul>
              ...
              <div class="box">
                    ...
                    <div class="box-body no-padding">
                      ...
                      <div class="table-responsive mailbox-messages">
                        <table class="table table-hover table-striped" id="tour-table">
                          <thead>
                          <tr class="info">
                            <th><input type="checkbox"></th>
                            <th class="mailbox-star"><center><a href="#">Id</a></center></th>
                            <th class="mailbox-name"><center><a href="#">Tour Name</a></center></th>
                            <th class="mailbox-name"><center><a href="#">Tour Date</a></center></th>
                            <th class="mailbox-name"><center><a href="#">Tour Pax</a></center></th>
                            <th class="mailbox-name"><center><a href="#">Tour Category</a></center></th>
                            <th class="col-sm-3"><center><a href="#">Tour Image</a></center></th>
                          ...
                          <tr class="info">
                            ...
                            <td class="mailbox-name"><center><a href="#"></a></center></td>
                            <td class="mailbox-date"><center><a href="#"></a></center></td>
                            <td class="mailbox-star"><center><a href="#"></a></center></td>
                            </center>
                            </td>
                          </tr>
...
$(document).ready(function(){
    ...
    $('#frm-tour-create').on('submit',function(e)
    {
        e.preventDefault();
        console.log('pressed');
